...
final class Console extends Panel
    ...
    private static final String[] fichiersFeu = { "img/feuRouge.gif", "img/feuVert.gif" };
    ...
    public void setIP(int ip) {
        textIP.setText(Integer.toString(ip));
    }

    // fixe le trait
    public void setTrait(boolean etat) {
        feu.setImage(etat ? 1 : 0);
    }
