/********************************************************************
* Confirmation (C) Michel CASABIANCA 1998 - casa@sdv.fr             *
********************************************************************/
...
implements WindowListener,ActionListener
{
	...
	String methodeOui,String methodeNon,String image)
	{
		...
		if(methodeNon!=null)
		{
			try {this.methodeNon=frame.getClass().getMethod(methodeNon,new Class[0]);}
			catch(NoSuchMethodException e) {e.printStackTrace();}
		}
	...
	public void actionPerformed(ActionEvent evt)
	{
		...
		if(cmd.equals("Oui")) 
		{
			if(methodeOui!=null)
			{
				try {methodeOui.invoke(frame,new Object[0]);}
		...
		else if(cmd.equals("Non")) 
		{
			if(methodeNon!=null)
			{
				try {methodeNon.invoke(frame,new Object[0]);}
				catch(Exception e) {e.printStackTrace();}
			}
			dispose();
		}
